...
import {postsQueryParams, normalizeNodes, normalizeTerms, PostsPage, PostsFormFilter} from 'vactory-gatsby-press-release'
...
const PostsContainer = ({pageContext: {node, nodes, terms}}) => {
    ...
    useEffect(() => {
            ...
            function fetchData() {
                ...
                Api.get('node/press_release', requestParams, node.langcode).then(data => {
