...
export const imageLayoutStyles = {
    threeColumns: {
        sizes: [
            {
                name: "publication_image_768_503",
            ...
            {
                name: "publication_image_675_442",
                media: "(min-width: 992px)",
            },
            {
                name: "publication_image_359_235",
    ...
    twoColumns: {
        sizes: [
            {
                name: "publication_image_480_314",
                media: "(max-width: 767px)",
            },
            {
                name: "publication_image_768_503",
            ...
            {
                name: "publication_image_546_358",
                media: "(min-width: 1200px)",
            },
        ],
        width: 546,
