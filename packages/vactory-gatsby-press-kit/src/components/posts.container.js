...
import {postsQueryParams, normalizeNodes, normalizeTerms, PostsPage, PostsFormFilter} from 'vactory-gatsby-press-kit'
...
const PostsContainer = ({pageContext: {node, nodes, terms}}) => {
    ...
    useEffect(() => {
            ...
            function fetchData() {
                ...
                Api.get('node/press_kit', requestParams, node.langcode).then(data => {
