...
// Processors
const customProcessors = path.join(process.cwd(), "src/vactory-gatsby-tender/internal/processors.js");
...
// API Posts params
const customPostsParams = path.join(process.cwd(), "src/vactory-gatsby-tender/internal/api.posts.params.js");
...
// API Taxonomy params
const customTaxonomyParams = path.join(process.cwd(), "src/vactory-gatsby-tender/internal/api.postTaxonomy.params.js");
