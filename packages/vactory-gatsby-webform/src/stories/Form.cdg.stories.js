        ...
        schema={{
            ...
            phoneNumber: {
                ...
                validation: {
                    ...
                    patternError: "Le champ 'Téléphone' n'est pas un numéro de téléphone Marocain valide",
                }
            },
            object: {
                type: 'text',
            ...
            agree: {
                type: 'checkbox',
                label: 'J\'ai lu et j\'accepte les conditions générales d\'utilisation, notamment la mention relative à la protection des données personnelles.',
                validation: {
                    required: true,
