...
export const LayerForm = () => {
    ...
    return (
        <Box>
            <Button mb="25px" type="button" borderRadius="rounded" outline="primary"
                    onClick={() => setShowLayerForm(true)}>Open
                form</Button>

            {showLayerForm && (
                <Layer onClickOutside={() => setShowLayerForm(false)}>
                    <Box p="medium" boxShadow={4} flexDirection="column" bg="white" borderRadius="small"
                         maxWidth="400px" minWidth="400px">
                        <Form
                            webformId={"test_form"}
            ...
            {showSuccessModal && (
                <Layer onClickOutside={() => setShowSuccessModal(false)}>
                    <Box p="medium" boxShadow={4} bg="white" borderRadius="small"
                          maxWidth="400px" minWidth="400px">
                        <Box>
                        ...
                        <Box mt="medium">
                            <Button borderRadius="rounded" mx="small" variant="danger"
                                    onClick={() => setShowSuccessModal(false)}>Close</Button>
                        </Box>
                    </Box>
                </Layer>
            )}
