...
// Processors
const customProcessors = path.join(process.cwd(), "src/vactory-gatsby-news/internal/processors.js");
const processors = fs.existsSync(customProcessors) ? esmRequire(customProcessors) : esmRequire("./src/internal/processors.js");

// AMP settings
const customAmpSettings = path.join(process.cwd(), "src/vactory-gatsby-news/internal/amp.js");
const ampSettings = fs.existsSync(customAmpSettings) ? esmRequire(customAmpSettings) : esmRequire("./src/internal/amp.js");

// API Post params
const customPostParams = path.join(process.cwd(), "src/vactory-gatsby-news/internal/api.post.params.js");
const postParams = fs.existsSync(customPostParams) ? esmRequire(customPostParams) : esmRequire("./src/internal/api.post.params.js");

// API Posts params
const customPostsParams = path.join(process.cwd(), "src/vactory-gatsby-news/internal/api.posts.params.js");
...
// API Taxonomy params
const customTaxonomyParams = path.join(process.cwd(), "src/vactory-gatsby-news/internal/api.postTaxonomy.params.js");
