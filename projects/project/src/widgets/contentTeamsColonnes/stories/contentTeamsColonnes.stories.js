...
import {ContentTeamsColonnesWrapper} from "../contentTeamsColonnesWrapper";
...
export const Variant1 = () => {
    ...
    return (
        <Container>
            <ContentTeamsColonnesWrapper {...data} />
        </Container>
    )
}
...
export default {
    title: 'Dynamic Fields/Teams en colonne Avec contenu Encadré',
