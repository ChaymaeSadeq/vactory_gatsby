...
export const TestComponents = () => {
  const isRtl = useRtl();
  const textRTL = isRtl ? 'مرحبا' : 'LTR Hello world.'

  return (
    <div>
      <div className="text-indigo-600 text-9xl ltr:pl-4 rtl:pr-4 ltr:font-museo-500 rtl:font-helvetica-700">
        {textRTL}
      </div>
      <ul className="children:block children:bg-gray-200">
        <li>First item</li>
